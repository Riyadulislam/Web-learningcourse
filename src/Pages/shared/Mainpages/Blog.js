        ...
        <div>
            ...
            <h1 className='text-center text-primary'>Blog</h1>
                <Row>
                    ...
                    <Col lg="6">
                    <h3 className='text-primary'>How does private route work?</h3>
                    ...
                    <h3 className='text-primary'>why are u using firebase?WWhat other options do you have to implement authentication?</h3>
